...
[Dist, RMSD, Transf, PBD2TX] = pdbsuperpose(P1, P2, 'Segment',{'26-140:A','42-150:A'});
...
%% Get Mulitiple Alignment

[Dist, RMSD, Transf, PBD2TX] = pdbsuperpose(P1, P2, 'display','off', 'Segment',{'31-137:A','44-150:A'});
[Dist, RMSD, Transf, PBD3TX] = pdbsuperpose(P1, P3, 'display','off', 'Segment',{'31-137:A','37-143:A'});
[Dist, RMSD, Transf, PBD4TX] = pdbsuperpose(P1, P4, 'display','off', 'Segment',{'31-137:A','44-150:A'});
[Dist, RMSD, Transf, PBD5TX] = pdbsuperpose(P1, P5, 'display','off', 'Segment',{'31-137:A','30-136:A'});
...
evalrasmolscript(h, [
    'select all; cartoons off; trace on; '... 
    'select model = 1 ; color red;'... % 1sjj
    'select model = 2 ; color green;'... % 1tjt
    'select model = 3 ; color pink;'... %4d1e
    'select model = 4 ; color cyan;'... %1wku
    'select model = 5 ; color grey;'... %2eyi
